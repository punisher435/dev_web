...
export default function BasicTable({room}) {
  ...
  const rows = [
    ...
    createData('Room_cleaning', `${room.room_cleaning ? 'Yes' : 'No'}` ),
  ...
  const rows1 = [
    ...
    createData('No. of Balcony in room', `${room.balcony ? 'Yes' : 'No'}` ),
    createData('No. of Windows in room', `${room.windows ? 'Yes' : 'No'}` ),
    createData('No. of Fans in room', `${room.fans ? 'Yes' : 'No'}` ),
    createData('Bed type', `${room.bed_type}` ),
    createData('Room floor no.', `${room.floor_no}` ),
