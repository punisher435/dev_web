        ...
        <TableBody>
          
          {
            bookings.map(
              ...
              <StyledTableCell align="right"><Link style={{textAlign: 'center',textDecoration:'none'}} to={`/dashboard/recentbookings/housing-bookings/${booking.booking_id}`}><Button>View details ...</Button></Link></StyledTableCell>
            </StyledTableRow>
