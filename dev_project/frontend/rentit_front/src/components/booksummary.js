...
export default function Review({bookdetails,setbookdetails}) {
  ...
  const products = [
    ...
    { name: 'Booking capacity', desc: '', price: `${bookdetails.capacity}` },
    ...
    { name: 'Please note that the price is increased due to transaction charges of payment gateway and taxes', price: `` },
  ];
  ...
  const facility = [
    ...
    { name: 'House TV', price: `${bookdetails.house_TV}` },
    { name: 'Room TV ', price: `${bookdetails.room_TV}` },
    { name: 'House refridgerator', price: `${bookdetails.house_refridgerator}` },
    { name: 'Room refridgerator', price: `${bookdetails.room_refridgerator}` },
    { name: 'Purified water', price: `${bookdetails.purified_water}` },
    { name: 'Geyser', price: `${bookdetails.geyser}` },
